...
<div class="container mt-4">
    <div class="card shadow-lg border-0 rounded-3">
        <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('petugas.deteksi_dini.index') }}" class="btn btn-light btn-sm">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="pasien_id" class="form-select @error('pasien_id') is-invalid @enderror" required>
                            ...
                            @foreach($pasien as $p)
                                <option value="{{ $p->id }}"
                                    {{ old('pasien_id', $deteksi->pasien_id) == $p->id ? 'selected' : '' }}>
                                    {{ $p->nama_lengkap }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="puskesmas" class="form-control @error('puskesmas') is-invalid @enderror"
                            placeholder="Nama Puskesmas" value="{{ old('puskesmas', $deteksi->puskesmas) }}" required>
