...
<div class="container-fluid py-4" style="background-color: #f8f9fa;">
    <div class="row mb-4 align-items-center">
        ...
        <div class="col-md-4 text-md-end mt-3 mt-md-0">
            <button type="button" data-bs-toggle="modal" data-bs-target="#modalSahkanLaporanEvaluasi" class="btn btn-outline-dark btn-sm rounded-pill shadow-sm px-4 fw-bold">
                <i class="bi bi-printer me-1"></i> Cetak & sahkan Laporan
            </button>
        </div>
    </div>

    <!-- MODAL PENGESAHAN EVALUASI -->
    <div class="modal fade" id="modalSahkanLaporanEvaluasi" tabindex="-1" aria-labelledby="modalSahkanEvaluasiLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-4 border-0 shadow-lg">
                <form action="{{ route('kepala.laporan.evaluasi.cetak') }}" method="GET" target="_blank">
                    ...
                    <div class="modal-header border-0 pb-0 pt-4 px-4">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div>
                                <h5 class="modal-title fw-bold text-dark mb-0" id="modalSahkanEvaluasiLabel">Pengesahan Laporan Evaluasi SUS</h5>
                    ...
                    <div class="modal-body px-4 py-3">
                        <div class="mb-2">
                            <label for="catatan_evaluasi" class="form-label fw-bold text-dark small mb-1">
                                <i class="bi bi-chat-left-text-fill text-success me-1"></i> Catatan / Arahan Kepala Bidang P2PTM:
                            </label>
                            <textarea class="form-control rounded-3" id="catatan_evaluasi" name="catatan_pengesahan" rows="3" placeholder="Masukkan catatan resmi pengesahan..." style="font-size: 0.85rem;" required>Laporan hasil evaluasi usabilitas dan kepuasan pelayanan sistem E-PTM telah diverifikasi dan disahkan.</textarea>
                    ...
                    <div class="modal-footer border-0 pt-0 pb-4 px-4 d-flex justify-content-end gap-2">
                        ...
                        <button type="submit" class="btn btn-success rounded-pill px-4 fw-bold btn-sm shadow-sm" onclick="setTimeout(function(){ bootstrap.Modal.getInstance(document.getElementById('modalSahkanLaporanEvaluasi')).hide(); }, 300);">
