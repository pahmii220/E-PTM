        ...
        <div class="card border-0 shadow-sm mb-4 rounded-4" style="background:linear-gradient(135deg,#eef2ff,#f8fafc)">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-end gap-2">
                    <button type="button" data-bs-toggle="modal" data-bs-target="#modalSahkanLaporanPeserta"
                        class="btn btn-outline-dark btn-sm rounded-pill shadow-sm px-4 fw-bold">
                        <i class="bi bi-printer me-1"></i> Cetak &amp; Sahkan Laporan
                    </button>
                </div>

                <!-- MODAL PENGESAHAN PESERTA -->
                <div class="modal fade" id="modalSahkanLaporanPeserta" tabindex="-1" aria-labelledby="modalSahkanPesertaLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content rounded-4 border-0 shadow-lg">
                            <form action="{{ route('kepala.laporan.peserta.cetak') }}" method="GET" target="_blank">
                                ...
                                <div class="modal-header border-0 pb-0 pt-4 px-4">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            <h5 class="modal-title fw-bold text-dark mb-0" id="modalSahkanPesertaLabel">Pengesahan Laporan Pasien PTM</h5>
                                ...
                                <div class="modal-body px-4 py-3">
                                    <div class="mb-2">
                                        <label for="catatan_peserta" class="form-label fw-bold text-dark small mb-1">
                                            <i class="bi bi-chat-left-text-fill text-success me-1"></i> Catatan / Arahan Kepala Bidang P2PTM:
                                        </label>
                                        <textarea class="form-control rounded-3" id="catatan_peserta" name="catatan_pengesahan" rows="3" placeholder="Masukkan catatan resmi pengesahan..." style="font-size: 0.85rem;" required>Data register pasien terverifikasi telah ditelaah dan disahkan.</textarea>
                                ...
                                <div class="modal-footer border-0 pt-0 pb-4 px-4 d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-success rounded-pill px-4 fw-bold btn-sm shadow-sm" onclick="setTimeout(function(){ bootstrap.Modal.getInstance(document.getElementById('modalSahkanLaporanPeserta')).hide(); }, 300);">
