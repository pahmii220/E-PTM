...
if ($latestCreate) {
    file_put_contents('C:\\laragon\\www\\E-PTM\\scratch\\recovered_create_3.blade.php', $latestCreate);
...
if ($latestEdit) {
    file_put_contents('C:\\laragon\\www\\E-PTM\\scratch\\recovered_edit_3.blade.php', $latestEdit);
